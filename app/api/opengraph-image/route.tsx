...
export async function GET(req: NextRequest) {
    try {
        ...
        if (!title) {
            return new NextResponse("Failed to get title", { status: 500 });
        }
            ...
            (
                <div tw="flex relative flex-col p-8 w-full h-full items-start text-black bg-white">
                    <div tw="flex items-center">
                        <img 
                            src='https://avatars.githubusercontent.com/u/72588333?s=400&u=5b731bc6416ab96314892311e04ec9fe4de0a7e9&v=4'
                            alt="icon-image"
                    ...
                    <div tw="flex flex-col flex-1 pb-10 pt-2">
                        <div tw="flex font-bold text-[25px] sm:text-[35px] lg:text-[45px] text-gray-500" style={{ fontFamily: 'Orbitron' }}> 
                            {headingForOGImage}
                        </div>
                    </div>
        ...
        return new NextResponse("Failed to generate Ograph image", { status: 500 });
    }
}