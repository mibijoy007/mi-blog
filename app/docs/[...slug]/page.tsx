...
// Filter out .gitkeep and non-existent entries cleanly
...
export async function generateMetadata({
  ...
  openGraphImageSearchParams.set(
    "title",
...
export default async function SingleBlogPage({
  ...
  try {
    ...
    const frontmatterDate =
      typeof compiledMDX.frontmatter.date === "string"
        ? compiledMDX.frontmatter.date
        : "";
    const fileStats = statSync(filePath);
    const fileDate = fileStats.birthtime.toISOString();

    date = frontmatterDate ? frontmatterDate : fileDate;
    ...
    return (
      <div className="min-h-dvh prose dark:prose-invert text-sm mx-auto max-w-4xl">
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }}
        />

        <div className="w-[18rem] sc350:w-[20rem] sc430:w-[25rem] sm:w-[35rem] md:w-[40rem] lg:w-[50rem] mx-auto md:text-xl">
          <h1 className="mx-auto font-bold text-3xl md:text-5xl mb-3 md:mb-5 pb-0 capitalize">
            {compiledMDX.frontmatter.title as string}
          </h1>
          <div>
...
//       {/* main content */}
//       {/* <div className="flex  mx-auto   max-w-3xl prose dark:prose-invert "> */}
//       {/* <div className="prose dark:prose-invert text-sm"> */}

//         <div className="w-[18rem] sc350:w-[20rem] sc430:w-[25rem]  sm:w-[35rem] md:w-[40rem] lg:w-[50rem] mx-auto  md:text-xl">
//         {/* <div className="max-w-none mx-auto  md:text-xl"> */}
//           {/* Frontmatter Title  */}
//           <h1 className="mx-auto font-bold text-3xl md:text-5xl mb-3 md:mb-5 pb-0 capitalize">
//           {compiledMDX.frontmatter.title as string}
//           </h1>
...
//           <article className="">{compiledMDX.content}</article>
//         </div>
...
// //   <div className="w-[18rem]  sm:w-[35rem] md:w-[40rem] lg:w-[50rem] mx-auto  md:text-xl">
// //   {/* <div className="max-w-none mx-auto  md:text-xl"> */}
// //     {/* Frontmatter Title  */}
// //     <h1 className="mx-auto font-bold text-3xl md:text-5xl mb-3 md:mb-5 pb-0 capitalize">
// //     {compiledMDX.frontmatter.title as string}
